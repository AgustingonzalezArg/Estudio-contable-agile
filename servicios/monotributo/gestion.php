...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="El mejor servicio y mas completo de gestion de monotributo que se adecua a tus necesidades y a tu bolsillo. Somos un estudio contable digital para que no tengas que moverte de tu negocio para gestionar tus impuestos.">
    ...
    <title>Gestion de monotributo - Córdoba</title>
</head>
<body>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <main>
        <section class="section-1">
            <h1>Gestion de monotributo en Córdoba</h1>
            <p>Realizamos una gestion eficiente, sin terminos complicados y de forma digital, para que solo tengas que dedicar 15 minutos al mes a tu monotributo y enfocarte en tu negocio. Alta, baja, recategorizacion, facturacion y más. </p>
        ...
        <section class="section-informational">
            <h2>¿Cómo gestionar un monotributo?</h2>
            <p>Para una gestion correcta del monotributo hay varios aspectos que hay que tener en cuenta, aquí te los nombramos:</p>
            <ul>
                <li>Alta monotributo</li>
                <li>Control de compras y ventas</li>
                <li>Control de facturacion</li>
                <li>Recategortizacion</li>
                <li>Facturacion</li>
            </ul>   
        </section>
        ...
        <section class="section-informational">
            ...
            <p>Las tarifas u honorarios por una gestion mensual del monotributo varía mucho segun el contador o estudio contable y que incluye el servicio. Pero en general en la provincia de Córdoba el servicio cuesta entre 25 mil y 50 mil pesos mensuales. Esto también varía dependiendo mucho de la provincia.</p>
        </section>
